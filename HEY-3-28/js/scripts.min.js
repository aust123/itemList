...
function(t) {
	...
	if($(window).width() >= 768 ? function() {
			$("#fullpage").fullpage({
				...
				onLeave: function(e, n, i) {
					1 == n ? ($(".footer__ounty, .footer__soc").addClass("no-visible"), $("#header-contribute-btn").hide(), $("#header-auth-btn").show()) : ($(".footer__ounty, .footer__soc").removeClass("no-visible"), $("#header-contribute-btn").show(), $("#header-auth-btn").hide()), $(".nav li.active").removeClass("active"), $(".nav li.prev").removeClass("prev"), $(".nav a[href='#" + t[n - 1] + "']").closest("li").addClass("active").prevAll().addClass("prev")
				},
				afterLoad: function(t, e) {
					1 == e ? ($(".footer__ounty, .footer__soc").addClass("no-visible"), $("#header-contribute-btn").hide(), $("#header-auth-btn").show()) : ($(".footer__ounty, .footer__soc").removeClass("no-visible"), $("#header-contribute-btn").show(), $("#header-auth-btn").hide()), 8 == e && $(".s_7__discount__progress_val span").spincrement({
						duration: 1500,
						easing: "linear"
					})
				}
	...
	n.owlCarousel({
			margin: 9,
			navText: ['<svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="16px"><path fill-rule="evenodd" class="fillPart" fill="rgb(72, 234, 221)" d="M9.014,0.000 L0.000,8.000 L9.014,16.000 L12.000,13.387 L5.931,8.000 L12.000,2.614 L9.014,0.000 Z"/></svg>', '<svg  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="12px" height="16px"><path fill-rule="evenodd" class="fillPart" fill="rgb(72, 234, 221)" d="M2.986,16.000 L12.000,8.000 L2.986,0.000 L0.000,2.613 L6.069,8.000 L0.000,13.386 L2.986,16.000 Z"/></svg>'],
			loop: !0,
			nav: !0,
			responsive: {
				1200: {
			...
			$(".district-descr.active").removeClass("active"), $($(".s_3 .owl-item.active .s_3__slide").attr("data-descr")).addClass("active")
		...
		function(t) {
			function e() {
				...
				for(var t = 0, e = l.length; t < e; t++) {
					var i = l[t];
					a.fillStyle = "#48eadd", a.beginPath(), a.arc(i.x, i.y, i.radius, 0, 10 * Math.PI), a.fill(), a.fillStyle = "black", a.stroke()
				}
				a.beginPath();
				for(var t = 0, e = l.length; t < e; t++) {
					var r = l[t];
				...
				a.lineWidth = .03, a.strokeStyle = "#48eadd", a.stroke()
			}
