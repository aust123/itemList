<template>
	<div>
		...
		<div class="cash_content" id="add_bankcard_content">
			...
			<div>
				<p><span>手机号</span><input v-model="phone_num" type="text" id="phone_num" value="" placeholder="请输入手机号" /></p>
				<p><span>验证码</span><input v-model="code_num" type="text" id="code_num" value="" placeholder="请收入验证码" /><b id="get_code" @click="getCode">获取验证码</b></p>
			</div>
		</div>
