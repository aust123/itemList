  ...
  <div class="billing">
    ...
    <form class="billForm divItem">
      ...
      <div class="form_item">
        <span>皮重</span>
        <em>吨</em>
        <input v-model="weight2" type="text"/>
      </div>
      <div class="form_item">
        <span>司磅净重</span>
        <em>吨</em>
        <input readonly v-model="weight3" type="text"/>
      </div>
    </form>
    <div class="account">
      <div class="h210">
  ...
  export default{
    ...
    computed:{
      ...
      settleWeight:function(){
        return (this.weight3*(1-this.settle_data.es_settle_watery-this.settle_data.es_settle_trash)/100).toFixed(3)
      },
    ...
    methods:{
      ...
      sure:function(){
        ...
        }else if(!this.checkWeight(this.weight2)||this.weight2>this.settle_data.es_rough_weight){
