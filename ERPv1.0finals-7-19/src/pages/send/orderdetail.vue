<template>
    ...
    <div class="order-detail-content">
      ...
      <section class="detail-info">
        ...
        <p class="detail-option"> <router-link :to="{path:'/delivery',query:{oid:sendDetailInfo.ego_id,path:$route.fullPath}}" class="order-sure"  v-if="sendDetailInfo.ego_state==1">发货</router-link></p>
