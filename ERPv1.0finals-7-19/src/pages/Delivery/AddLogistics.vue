<template>
  <div class="billing">
    ...
    <form class="billForm divItem">
      ...
      <div class="form_item">
        <span>车牌号</span>
        <input class="input1" v-model="carNumber" maxlength="12" type="text" placeholder="请输入车牌号"/>
      </div>
      <div class="form_item">
        <span>司机姓名</span>
        <input class="input2" v-model="name" maxlength="25" type="text" placeholder="请输入司机姓名"/>
      </div>
      <div class="form_item">
        <span>司机身份证号</span>
