    ...
    <div>
      <header>
       ...
       <!-- <Header searchurl='/saleSearch' otype='2'><span slot="title">采购订单</span></Header>   -->
        <navBar :navList='navBar' @changeType='switchState' ref='navbar' buy='1'></navBar>
       ...
       <mt-loadmore
            ...
            :bottomDistance=90
             ref="loadmore">
       <List  :dataList='orderListData' :type='otype' @removeKey='removeSearchKey' ref="list" @reload='reloadData'></List>
