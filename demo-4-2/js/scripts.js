...
var ttt = UDate().getTimezoneOffset(),
	...
	qqq = (new Date(2018, 3, 20, 12, 59, 59)).getTime() + xxx * 60 * 60 * 1000,
	www = new Date(qqq);
...
! function(t, e) {
	...
	function P(t, e) {
		for(var n, i, r, o = [], a = 0, s = t.length; s > a; a++) i = t[a], i.style && (o[a] = bt.get(i, "olddisplay"), n = i.style.display, e ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Lt(i) && (o[a] = bt.access(i, "olddisplay", R(i.nodeName)))) : (r = Lt(i), "none" === n && r || bt.set(i, "olddisplay", r ? n : ot.css(i, "display"))));
...
$(function() {
	...
	n.owlCarousel({
		...
		$(".s_8 .mCSB_draggerContainer").addClass("not_scroll"), $(".s_8 .mCSB_draggerContainer").attr("data-text", $(".s_8__staff_wrap").attr("data-scrolltext")), $(".s_8__staff__more").on("click", function() {
		...
		$(".menu-btn").on("click", function() {
			$("body").toggleClass("show-menu"), $("body").hasClass("show-menu") ? $.fn.fullpage.setAllowScrolling(!1) : $.fn.fullpage.setAllowScrolling(!0)
		}),
		$(".nav li").on("click", function() {
			$("body").removeClass("show-menu"), $.fn.fullpage.setAllowScrolling(!0)
		}),
		...
		}("page-bg-2"), $(".preload").addClass("preload-hide"), setTimeout(function() {
