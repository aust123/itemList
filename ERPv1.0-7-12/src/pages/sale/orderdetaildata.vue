<template>
    <div class="order-detail-content">
      ...
      <template v-if="orderDetailData.order_state != 1 && orderDetailData.order_state != 2 && orderDetailData.order_state != 3 && orderDetailData.order_state != 4">  
        ...
        <template v-if="orderDetailData==1">
          <p class="detail-option"><a class="cancel" href="javascript:;" @click="fn">取消</a></p>
          <p class="detail-option"><a  href="javascript:;" @click="fn">确认</a></p>
        </template>
