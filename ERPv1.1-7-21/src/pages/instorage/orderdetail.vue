<template>
    <div>
         <Header :noSearch='0' backurl='/instoragelist'><span slot="title" >入库单详情</span></Header>
    <div class="order-detail-content">
      ...
      <section class="detail-info">
        ...
        <p class="detail-option"  v-if="instorageDetailInfo.eps_state==1"> <router-link :to="{path:'/stockIn',query:{sid:instorageDetailInfo.eps_storehouse_id,oid:oid}}" >入库</router-link></p>
