  ...
  <div class="billing">
    ...
    <form class="billForm divItem">
      ...
      <div class="form_item">
        <span>司磅净重</span>
        <em>吨</em>
        <input class="input3" v-model="weight" type="text" placeholder="请输入结算单上扣除皮重后的净重量"/>
      </div>
      <div class="form_item">
        <span>结算单价</span>
        <em>元/吨</em>
      ...
      <div class="form_item">
        <span>其他扣除</span>
        <em>元</em>
        <input class="input3" v-model="qtkc" type="text"/>
      </div>
      <div class="form_item">
        <span>扣除原因</span>
        <input class="input2" v-model="kcyy" maxlength="250" type="text" placeholder="请输入扣除原因"/>
      </div>
    </form>
