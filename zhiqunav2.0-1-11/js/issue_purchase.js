    ...
    function editprimary(_data){
        if(_data.status_code=='10000'){
            ...
            for(var i=0;i<data.pn_photos.length;i++){
                html += '<li class="simg"><img src="https://two.zhiqunale.cn/'+ data.pn_photos[i] + '"/></li>';
            }
...
//                                }
        ...
        } else //兼容IE
        {
            ...
            var filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='https://two.zhiqunale.cn/" + imgSrc + "', sizingMethod='scale')";
