<template>
    <div>
        <Header :noSearch='0'><span slot="title">结算单详情</span></Header>  
      ...
      <h3 class="item-title">质检信息</h3>
       ...
       <p style="padding-bottom:10px">应付金额：<span class="total">￥{{settle_data.es_pay_money}}</span></p>
        ...
        <p class="detail-option" ><router-link  :to="{path:'/accountSure',query:{oid:settle_data.es_order_id,sid:sid}}">结算</router-link></p>
       </div>   
    </div>
</template>
<script>
