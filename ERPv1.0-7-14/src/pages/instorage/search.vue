        ...
        <section class="search-history">
            <template v-if="history.length>0">
              <div class="history-content"  v-show="!isInput">              
                ...
                <p v-for="(item,index) in history" :key="index" @click.self="toList(item)">{{item}}<img @click.self="remove(index,item.list_id)" src="../../assets/imgs/sellorder_key_cancel.png" alt=""></p>
              </div>
            </template>
