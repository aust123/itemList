<template>
    <div>
         <Header :noSearch='0'><span slot="title">出库单详情</span></Header>   
    <div class="order-detail-content">
      ...
      <section class="detail-info">
        ...
        <p class="detail-option"> <router-link :to="{path:'/stockOut',query:{oid:outstorageDetailInfo.edo_id}}"  v-if="outstorageDetailInfo.edo_state==1">出库</router-link></p>
