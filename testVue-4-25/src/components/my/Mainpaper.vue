  ...
  import { Scroller } from 'vux'
    ...
    components: {
      ...
      submitpaper:function(){
        this.mainpaper.paper_id=$('.paper-list li.active').attr('data-paper_id');
        this.mainpaper.paper_type=$('.paper-list li.active').attr('data-paper_type');
        this.mainpaper.paper_name=$('.paper-list li.active b').html();
...
<style scoped="scoped">
  ...
  .select_area button{
    ...
    position: relative;
    overflow: hidden;
    background-image: url('../../assets/img/my_shop_circle_n.png');
    background-repeat: no-repeat;
    background-size: 19px 19px;
    background-position: 5% center;
	}
  .paper-list li.active{
    background-image: url('../../assets/img/my_shop_circle_p.png');
  }
  .paper-list li input{
    position: absolute;
    top: 35%;
