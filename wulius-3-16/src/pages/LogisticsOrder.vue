<template>
	<div>
		<header class="header">
			...
			<span class="title">物流订单</span>
		</header>		
		<div class="content" style="bottom: 0;">
			<div class="certiPics releaseDetail">
				<yd-pullrefresh :callback="loadRefush" ref="pullrefreshDemo" :show-init-tip='false'>
		...
		methods: {
			...
			api.GetLogisticsList(data).then(res => {
				...
				if(err.data.status_code == 10000) {
					...
					var list = datas;
						this.logisticsList.push.apply(this.logisticsList, list);
						/*下拉加载提示内容*/
