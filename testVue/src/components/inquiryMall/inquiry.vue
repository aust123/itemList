				...
				<ul>
					<li v-for="item in quoteList" class="myintention_item inquiry_item">
						...
						<div class="operate operating">
							<router-link to="/quotePrice" class="cancel"><img src="../../assets/img/sell_qiugoudating_baojia.png" alt="" />报价</router-link>
		...
		methods: {
			...
			getQuoteList(data) {
				if(data.status_code == 10000) {
					...
					this.noneMsg = data.data.length > 0 ? false : true;
				} else {
					this.noneMsg = true;
				}
			}
