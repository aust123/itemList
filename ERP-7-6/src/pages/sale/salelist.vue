<template>
    <div>
        <header>
            ...
            销售列表
            <a class="search right" href="javasvript:;"><img src="../../assets/imgs/nav_icon_search.png" ></a>
        </header>
        <nav>
        ...
        <div class="content">
            <div class="queryItem">
                <span>皖A99999<img src="../../assets/imgs/sellorder_key_cancel.png" alt=""></span>               
            </div>
            <section class="orderList">
                ...
                <p class="order-list-info"><img src="../../assets/imgs/orderdetail_img.png" alt=""><b>A级</b><b>国废标准纸</b><b>100</b><b>吨</b><span>安徽省纸元网络科技</span></p>
                ...
                <p class="order-list-option">
                    ...
                    <a class="order-to-detail" href="javascript:;">详情</a>                   
                </p>
            </section>
             <section class="orderList">
                <p class="order-list-title"><img src="../../assets/imgs/sellorder_icon_orderid.png" alt="">SA8884545454<span class="date">今天</span><span class="status">待确认</span></p>
