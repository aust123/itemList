...
$('.supplyMsgList').delegate('tr','click',function(){
    if($(this).attr('data-sw_purchase_id')==0){
        window.open('../mall/key_sellers_detail.html?swid='+$(this).attr('data-sw_id')+'&saleid='+$(this).attr('data-sw_saler')+'&pnm='+$(this).attr('data-pnm'));
    }else{
