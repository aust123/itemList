	...
	<div class="sale">
		...
		<div class="classify">
			<ul>
				...
				<li>
					<a href="http://wechat.zhiqunale.cn/hangqing.html">
						<p>
...
<script>
	...
	export default {
		...
		mounted() {
			...
			if(this.$store.state.loginUser.uid){
				params.user_id=this.$store.state.loginUser.uid;
				params.device_number=this.$store.state.loginUser.device_number;
			}
