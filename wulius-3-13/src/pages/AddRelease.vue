	...
	<div>
		...
		<div id="add_release">
			<div class="write_release">
				...
				<p>
					<yd-cell-group>
						...
						<yd-cell-item arrow>
							...
							<!--<input type="text" unselectable disabled id="from" value="" placeholder="请选择出发地" />-->
							<input slot="right" type="text" @click.stop="show2 = true" v-model="model2" readonly placeholder="请选择出发地">
						</yd-cell-item>
						<yd-cell-item arrow>
				...
				<p><span>出发日期：</span><input type="text" id="date" value="" placeholder="请选择出发日期" /></p>

				<p><span>承载量（吨）：</span><input type="text" id="weight" value="" v-model="weight" placeholder="请填写货车承载量" /></p>
				<p v-if="is_mianyi==1"><span>费用（元）：</span><input type="text" id="money" value="" v-model="fee" placeholder="请填写费用" /></p>
				<p>
					<span>费用是否面议：</span>
					<input type="radio" id="no" value="1" v-model="is_mianyi"/><label for="no">否</label>
					<input type="radio" id="yes" value="2" v-model="is_mianyi"/><label for="yes">是</label>
				</p>
			</div>
