<template>
  <div>
    ...
    <div class="publish_form pub_logistics">
      <p>
        <span>出发地</span>
        <router-link to="/myAddress">请选择发货地址</router-link>
      </p>
      <p>
        <span>目的地</span>
        <router-link to="/myAddress">请选择收货地址</router-link>
      </p>
      <p>
        <span>发货日期</span>
      ...
      <p>
        <span>货物品类</span>
        <input type="text" placeholder="请填写货物品类"/>
      </p>
      <p>
        <span>货物重量</span>
        <input type="text" placeholder="请填写货物重量"/>
      </p>
      <p>
        <span>联系方式</span>
        <input type="tel" placeholder="请填写联系方式"/>
      </p>
      <p>
        <span>备注</span><br/>
        <textarea placeholder="请填写您的需求备注。"></textarea>
      </p>
    </div>
